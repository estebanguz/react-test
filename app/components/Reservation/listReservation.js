        ...
        <React.Fragment>                   
            ...
            <Box className = {styles.search}>
                ...
                <InputBase       
                    ...
                    onChange = {(e)=>{                                                                                                                                                 
                        setPageActual(1) 
                        setRequest({page: pageActual, size : limit ,filtro: e.target.value})
                        setSearch(true)
                    }}                    
            ...
            <Box component = "div">
                ...
                <Select 
                    ...
                    onChange = {(e)=>{                        
                        ...
                        setRequest({page: pageActual, size : e.target.value , filtro : request.filtro})                                            
                    }}
                >
