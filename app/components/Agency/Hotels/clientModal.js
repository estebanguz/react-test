      ...
      <DialogContent className={classes.modalIndex}>
        <DialogContentText id="alert-dialog-description">
          ...
          >
            ...
            <Grid item md={12} sm={12} xs={12}>
              <Typography>
                <b>Habitaciones: </b> {hotelDetails[0].search.room}
              </Typography>
            </Grid>
            <Grid item md={6} sm={12} xs={12}>
              <Typography>
                <b>Adultos: </b> {hotelDetails[0].search.adults}
              </Typography>
            </Grid>
            <Grid item md={6} sm={12} xs={12}>
              <Typography>
                <b>Menores: </b> {hotelDetails[0].search.children}
              </Typography>
            </Grid>
            {loader ? (
              <Grid item md={12} sm={12} xs={12} className={classes.loaderDiv}>
          ...
          >
            <Grid md={12}>
              <Typography className={classes.precioHabitacion}>
                <b>
                  Precio de Habitación: ${parseFloat(precio_hab).toFixed(2)} MXN
                </b>
              </Typography>
            </Grid>
          </Grid>
