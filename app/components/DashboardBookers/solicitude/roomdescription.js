					...
					<Grid item xs={3}>
						<FormControl className={classes.formControl}>
							...
							>
								...
								<MenuItem value="Semi Todo Incluido">
									Semi Todo Incluido
								</MenuItem>
					...
					<Grid item xs={openDate == 1 ? 6 : 3}>
						<FormControl className={classes.formControl}>
							...
							>
								...
								<MenuItem value="Habitación Estándar">
									Habitación Estándar
								</MenuItem>
								<MenuItem value="Habitación Doble">Habitación Doble</MenuItem>
								<MenuItem value="Habitación Estudio">
									Habitación Estudio
								</MenuItem>
							...
							<FormControl className={classes.formControl}>
								<MuiPickersUtilsProvider utils={MomentUtils}>
									<DatePicker
										...
										value={arrivalDate}
										onChange={(d) =>
											setArrivalDate(d.toISOString().slice(0, 10))
										}
					...
					<Grid item xs={3}>
						<FormControl className={classes.formControl}>
							...
							>
								...
								<MenuItem value="Acta de Matrimonio">
									Acta de Matrimonio
								</MenuItem>
